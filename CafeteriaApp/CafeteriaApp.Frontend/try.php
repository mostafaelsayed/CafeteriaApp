<?php
    require_once(__DIR__ . '/../CafeteriaApp.Backend/Controllers/Notification.php'); 
...
<html>
    ...
    <body ng-app="myapp" style="margin: 0;padding: 0">
        ...
        <div ng-controller="Ctrl">
            <div>
                <select class="selectpicker show-tick" ng-model="selectedOption"
