...
<br>
<div class="col-lg-5"  ng-controller="favorites"  style="align-content:center;text-align:center;position: absolute;top:100px;">
<h2   style=" color:orange;text-align:center;">My Favorites</h2>
...
<table align="center"  class="table" style=" margin:30px;" ng-show="favoriteItems.length > 0"  >
        ...
        <tbody  >
          <tr ng-repeat="fi in favoriteItems">
            ...
            <a class="btn btn-primary btn-circle" title="Remove Favorite Item" ng-click="deleteFavorItem(fi.MenuItemId,$index)" style="color:white;font-style:italic" ><i class="fa fa-minus"></i> </a>
           <a class="btn btn-primary btn-circle" title="Add to Cart" ng-click="addToOrder(fi.MenuItemId)" style="color:white;font-style:italic" ><i class="fa fa-plus"></i> </a>
