var show_and_delete_cafeteriasApp = angular.module('show_and_delete_cafeterias',
  ['modal', 'angularModalService', 'ui.bootstrap']);

show_and_delete_cafeteriasApp.controller('showAndDeleteCafeterias',
  ['$scope', '$http', 'ModalService', function($scope, $http, ModalService) {

  $scope.show = function(cafeteria) {
  ...
  $scope.deleteCafeteria = function(cafeteria) {
    $scope.show(cafeteria);
  };

  $scope.delete = function(cafeteria) {
