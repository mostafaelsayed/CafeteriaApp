...
$(document).ready(function(){
    $(window).scroll(function() {
        if ($(document).scrollTop() > 50) {
          $("#logo").attr("src", "/Content/Customer/images/Logo_stick.png")
        }
        else {
          $("#logo").attr("src", "/Content/Customer/images/Logo_main.png")
        }
    });
});
/*=================================================================
...
$(document).ready(function () {
    $("#loadMenuContent").click(function(event) {
        ...
        $.get("/content/customer/php/ajax_menu.html", function(data){
