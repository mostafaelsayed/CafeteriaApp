...
layoutApp.controller('favorites', ['$scope', '$http', '$rootScope', '$timeout', 'Order_Info', function($scope, $http,
$rootScope, $timeout, Order_Info) {
	...
	$scope.deleteFavorItem = function(menuItemId, index) {
      ...
      Order_Info.togglePopup('Favorite Item successfully removed !');
    });
	};
    ...
    if (x.length > 0) {
      ...
      .then(function(response) {
        ...
        Order_Info.togglePopup('Favorite Item added successfully to the order removed !');
      });
    }
  };
