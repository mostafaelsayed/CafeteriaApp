layoutApp.controller('getMenuItemsAndCustomerOrder', ['$rootScope', '$scope', '$http', 'Order_Info', function($rootScope, $scope, $http, Order_Info) {

	$scope.data = Order_Info;

	$http.get('../../CafeteriaApp.Backend/Requests/search.php').then(function(response) {
