...
if ($_SERVER['REQUEST_METHOD']=="POST")
{
  ...
  {
    processPayment($conn,$_POST["orderId"],$_POST["selectedMethodId"],$_POST["categoryId"],$paypal);
  }
  elseif (isset($_POST["paymentId"]))
  {
    echo chargeCustomer($_POST["paymentId"],$_POST["payerId"],$paypal,$_POST["categoryId"],$_POST["orderId"],$_POST["deliveryTimeId"],$_POST["deliveryPlace"],$_POST["paymentMethodId"],$conn);
  }
}
