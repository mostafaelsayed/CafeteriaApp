...
if ($_SERVER['REQUEST_METHOD'] == 'PUT') {
    if ($_SESSION['roleId'] == 1) {
        ...
        if (isset($data->Id, $data->Price, $data->Visible, $data->Name, $data->Description, $data->Image) && testMutipleInts($data->Id, $data->Visible) && normalizeString($conn, $data->Name, $data->Description, $data->Image) && testPrice($data->Price)) {
