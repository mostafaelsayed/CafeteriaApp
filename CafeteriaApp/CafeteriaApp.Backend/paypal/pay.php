		...
		try {
			...
			if ($transactionStatment->execute() === true) {
				...
				if ($result) {
					...
					if ($result) {
						$returnUrl = "http://127.0.0.1/CafeteriaApp/CafeteriaApp/CafeteriaApp.Frontend/Public/showing cafeterias.php";
					...
					$returnUrl = "http://127.0.0.1/CafeteriaApp/CafeteriaApp/CafeteriaApp.Frontend/Customer/checkout.php";
					header("Location: " . $returnUrl);
				}	
			}
			else {	
